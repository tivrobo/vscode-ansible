...
connection.onDidChangeConfiguration(didChangeConfigurationParams => {
  ...
  enableHover = clientSettings.ansible_yaml.hover;
  enableValidation = clientSettings.ansible_yaml.validation;
  updateConfiguration();
});
...
function validateTextDocument(textDocument: TextDocument): void {
  ...
  languageService.doValidation(textDocument, yamlDocument).then(
    diagnosticResults => {
